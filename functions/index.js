'use strict';
const cmbbfunc = require('./cmbb');
const scorefunc = require('./score');
...
exports.cmbb = functions.https.onRequest((req, res) => {
    cmbbfunc.handler(req, res);
});

exports.score = functions.https.onRequest((req, res) => {
    scorefunc.handler(req, res);
});
//exports.cmbb = functions.https.ref('/cmbb').onRequest((req, res)//functions.database.ref('/foo').onWrite(fooModule.handler);
